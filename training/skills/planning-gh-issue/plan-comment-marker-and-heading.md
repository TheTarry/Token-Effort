...
- The comment body starts with `<!-- token-effort:planning-gh-issue -->` on its own line.
...
- [ ] The comment body begins with `<!-- token-effort:planning-gh-issue -->` as the very first line.
