...
The user runs `/token-effort:building-gh-issue 15`. The issue exists and has 2 comments, but neither comment starts with `<!-- brainstorming-gh-issue:spec -->`. No spec has been produced for this issue yet.
